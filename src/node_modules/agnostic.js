...
var Program_icat = require('programs/icat');
...
function createInteractiveShell()
{
	...
	// Create a basic directory structure resembling what may be found in Anima proper.

	sh.fs.mkdir("/Userhome",true);
	sh.fs.mkdir("/Userhome/Photos", true);
	sh.fs.mkdir("/Apps",true);
	sh.fs.mkdir("/System", true);
	

	// Create dummy media files coinciding with real files served by the website.

	var fl = sh.fs.openfile("/Userhome/Photos/kitten.jpg",true);
	var fl = sh.fs.openfile("/Userhome/Photos/punch-buggy.jpg",true);

	// Create a few dummy files/applications for the demo.
